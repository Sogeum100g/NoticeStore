...
class RecommendSiteScreen extends StatelessWidget {
  ...
  Widget _buildCategorySection(
      BuildContext context, {
        ...
        required Color themeColor, // 카테고리별 포인트 색상
      }) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        Wrap(
          ...
          children: sites.map((site) => Container(
            ...
            decoration: BoxDecoration(
              // 배경은 아주 연하게, 테두리는 없이 처리하여 '라벨' 느낌 강조
              color: themeColor.withOpacity(0.12),
              borderRadius: BorderRadius.circular(6), // 약간 각진 모서리가 더 정보 위젯답습니다.
            ),
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                // 작은 불렛 포인트 추가 (정보임을 명시)
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 13,
                    color: themeColor.withOpacity(0.8), // 텍스트를 진하게 하여 시인성 확보
